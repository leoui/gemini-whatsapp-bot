...
## 🖥️ Bot Manager — macOS Desktop App (v1.2.1)
...
#### v1.2.1 (2026-03-09)
- **🐛 Fix:** Startup crash `SyntaxError: Identifier 'fs' has already been declared` — duplicate module `require` declarations removed
- **📱 WhatsApp Number panel:** Change the linked WhatsApp account without SSH — wipes Baileys session on VPS and restarts bot
- **📷 In-app QR scanner:** QR renders directly in the app; auto-polls every 5s, 60s countdown with auto-refresh on expiry
...
| Platform | File |
|---|---|
| Apple Silicon (M1–M4) | `Bot Manager-1.2.1-arm64.dmg` |
| Intel Mac | `Bot Manager-1.2.1-x64.dmg` |
